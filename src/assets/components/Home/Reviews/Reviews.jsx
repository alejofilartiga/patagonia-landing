...
function Reviews() {
  return (
    <section className="bg-[#BF5B04] flex flex-col  items-center justify-center gap-8 w-full py-10" >

      <div className="flex flex-col items-center justify-center text-white text-center">
        <h2 className="font-espiritu md:text-6xl text-2xl">CONFIAN EN NOSOTROS</h2>
        <p className="font-poppins md:text-3xl text-xl text-balance" >Nuestro amor cervecero, en todos lados.</p>
      </div>

      <div className="flex flex-col md:flex-nowrap md:flex-row flex-wrap p-4 gap-10 font-poppins ">
        ...
        <div className="flex flex-col items-center justify-center gap-4 bg-[#035F43] p-4">
          ...
          <div className="flex gap-2 items-center justify-center">
            ...
            <img className="size-7" src={hops}/>
            <img className="size-7" src={hops} />
            <img className="size-7" src={hopsblank}/>
          </div>
          <div className="bg-[#E2D098] w-11/12 p-4">
