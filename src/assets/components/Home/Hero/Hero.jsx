...
function Hero() {
  return (
    <section className="flex col items-center  w-full justify-center md:justify-start h-svh relative " style={{ backgroundImage: `url(${heroimg})`, backgroundSize: 'cover', backgroundPosition: '80%'  }}>
      ...
      <div className="flex md:items-start md:p-10 justify-center items-center gap-8 flex-col p-3 relative z-10">
        ...
        <a className="font-poppins text-white md:text-2xl text-sm p-3 px-14 bg-[#D98E04] rounded-2xl" target="_blank" href="https://link.tada.com.ar/3qSL/MPATAGONIA">CONSEGUILA</a>
      </div>
    </section>
  )
}
